...
$result = Invoke-RestMethod -Method Post -Uri "$BaseUrl/api/workflows/xhs/feishu-write/publish" -ContentType "application/json" -Body ([System.Text.Encoding]::UTF8.GetBytes($payload))

Write-Host "Feishu publish write dry-run completed."
