...
$response = Invoke-RestMethod -Method Post -Uri "$BaseUrl/api/workflows/xhs/postgres-persistence/publish" -ContentType "application/json; charset=utf-8" -Body ($body | ConvertTo-Json -Depth 8)
